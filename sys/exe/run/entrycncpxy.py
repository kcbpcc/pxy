...
symbols = ["ZOMATO.NS", "PNB.NS", "HDFCBANK.NS", "SBIN.NS", "ITC.NS", "BEL.NS", "JIOFIN.NS", "IOC.NS", "BANKBARODA.NS", "TATASTEEL.NS", 
           "TATAPOWER.NS", "HDFCLIFE.NS", "ICICIBANK.NS", "IRFC.NS", "GAIL.NS", "LT.NS", "TATAMOTORS.NS", "ADANIPOWER.NS", "ONGC.NS", 
           "PFC.NS", "COALINDIA.NS", "MOTHERSON.NS", "POWERGRID.NS", "CANBK.NS", "MARICO.NS", "NTPC.NS", "ICICIGI.NS", "HCLTECH.NS", 
           "RECLTD.NS", "BPCL.NS", "HINDALCO.NS", "INFY.NS", "DABUR.NS", "VEDL.NS", "KOTAKBANK.NS", "RELIANCE.NS", "AXISBANK.NS", 
           "BHARTIARTL.NS", "M&M.NS", "INDUSINDBK.NS", "WIPRO.NS", "ASIANPAINT.NS", "TECHM.NS", "AMBUJACEM.NS", "TATAMTRDVR.NS", 
           "DLF.NS", "SBILIFE.NS", "TITAN.NS", "ADANIPORTS.NS", "JSWSTEEL.NS", "VBL.NS", "BERGEPAINT.NS", "HEROMOTOCO.NS", "TATACONSUM.NS", 
           "LICI.NS", "IRCTC.NS", "HAVELLS.NS", "TVSMOTOR.NS", "HINDUNILVR.NS", "HAL.NS", "BAJFINANCE.NS", "TCS.NS", "SUNPHARMA.NS", 
           "BAJAJFINSV.NS", "CHOLAFIN.NS", "ZYDUSLIFE.NS", "CIPLA.NS", "GODREJCP.NS", "ADANIENT.NS", "SRF.NS", "ICICIPRULI.NS", "LTIM.NS", 
           "DMART.NS", "ADANIENSOL.NS", "APOLLOHOSP.NS", "JINDALSTEL.NS", "EICHERMOT.NS", "SHRIRAMFIN.NS", "INDIGO.NS", "TRENT.NS", 
           "ATGL.NS", "NESTLEIND.NS", "DIVISLAB.NS", "ADANIGREEN.NS", "SBICARD.NS", "PIDILITIND.NS", "GRASIM.NS", "DRREDDY.NS", 
           "BAJAJ-AUTO.NS", "MARUTI.NS", "SIEMENS.NS", "ULTRACEMCO.NS", "BRITANNIA.NS", "MCDOWELL-N.NS", "ABB.NS", "COLPAL.NS", 
           "NAUKRI.NS", "TORNTPHARM.NS", "BAJAJHLDNG.NS", "SHREECEM.NS", "BOSCHLTD.NS"]
