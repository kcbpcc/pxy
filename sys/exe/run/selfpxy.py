...
def get_random_spiritual_message():
    spiritual_messages = [
        ...
        "Breathe deeply and find the serenity within. 🌬️",
        ...
        "Create your own sunshine on cloudy days. ☀️",
        ...
        "Success is not about the destination; it's about the journey. 🛤️",
        ...
        "Love is the most powerful force in the universe; share it generously. ❤️",
