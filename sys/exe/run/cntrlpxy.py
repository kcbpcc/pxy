...
###########################################################################################################################################################################################################
    ...
    PRINT_df[' Y'] = PRINT_df[' Y'].replace({'CNC': '🗓️', 'MIS': '⌛'})
...
###########################################################################################################################################################################################################    
    ...
    cnc_filtered_df = PRINT_df_sorted_display[(PRINT_df_sorted_display['PL%'] > cnc_filter ) & (PRINT_df_sorted_display['Q'] == '+') & (PRINT_df_sorted_display[' Y'] == '🗓️')]
    mis_filtered_df = PRINT_df_sorted_display[(PRINT_df_sorted_display['PL%'] < 0) & (PRINT_df_sorted_display['Q'] == '-') & (PRINT_df_sorted_display[' Y'] == '⌛')]
