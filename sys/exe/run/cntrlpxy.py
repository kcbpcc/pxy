...
###########################################################################################################################################################################################################
        ...
        print(right_aligned_format.format(f"{DangerBear}::pbPnL:{BRIGHT_GREEN if total_PnL_percentage_positions_buy >= 0 else BRIGHT_RED}{total_PnL_percentage_positions_buy}{RESET}"))
