...
###########################################################################################################################################################################################################
        ...
        print(left_aligned_format.format(f"nMIS:{BRIGHT_GREEN if total_PnL_percentage_mis_sell >= 0 else BRIGHT_RED}{total_PnL_percentage_mis_sell}{RESET}"), end="")
        ...
        print(right_aligned_format.format(f"pMIS:{BRIGHT_GREEN if total_PnL_mis_buy >= 0 else BRIGHT_RED}{total_PnL_mis_buy}{RESET}"))
        print("*" * 42)
