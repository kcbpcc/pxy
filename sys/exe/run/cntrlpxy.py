...
###########################################################################################################################################################################################################
        ...
        print(right_aligned_format.format(f"CNC::{BRIGHT_GREEN if total_PnL_cnc_buy >= 0 else BRIGHT_RED}{total_PnL_cnc_buy}//+MIS:::{BRIGHT_GREEN if total_PnL_mis_buy >= 0 else BRIGHT_RED}{total_PnL_mis_buy}{RESET}"))
