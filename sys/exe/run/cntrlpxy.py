...
###########################################################################################################################################################################################################
    ...
    PRINT_df = PRINT_df.rename(columns={'source': 'HP', 'product': 'CM', 'qty': 'Q', 'smbchk': '','key': 'key','dPL%': 'dPL%'})
...
###########################################################################################################################################################################################################    
    ...
    if not cnc_filtered_df.empty:
        ...
        print(cnc_filtered_df.to_string(index=False, justify='left', col_space=0, line_width=9999))
