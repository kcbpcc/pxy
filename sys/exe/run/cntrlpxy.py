...
###########################################################################################################################################################################################################    
    ...
    numeric_columns = ['smb_power','smbchk','oPL%','pstp','_pstp','qty', 'average_price', 'Invested','Yvalue', 'ltp','close', 'open', 'high', 'low','value', 'PnL', 'PL%','PL%_H', 'dPnL', 'dPL%']
...
###########################################################################################################################################################################################################
    ...
    PRINT_df = pxy_df[['source','product','key','dPL%','oPL%','smb_power','PL%','PnL','qty','smbchk']]
...
###########################################################################################################################################################################################################    
    ...
    PRINT_df_sorted['key'] = PRINT_df_sorted['key'].str.replace(r'(BSE:|NSE:)', '', regex=True).str[:10]
...
###########################################################################################################################################################################################################                    
                    if (
                        ...
                        (
                            ...
                            (row['source'] == 'positions' and row['PL%'] > (cnc_target )) 
                        )
                    ):
                        try:                            
