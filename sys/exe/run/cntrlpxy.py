            ...
            if order_id:
                ...
                with open(csv_file_path, 'a', newline='') as csvfile:
                    ...
                    try:
                        ...
                        message_text = f"{str(row)} https://www.tradingview.com/chart/?symbol={key}          Booked:{result}"
...
###########################################################################################################################################################################################################
        ...
        print(left_aligned_format.format(f"intraSell::{DangerBear}:{BRIGHT_GREEN if total_PnL_percentage_mis_sell >= 0 else BRIGHT_RED}{total_PnL_percentage_mis_sell}{RESET}"), end="")
