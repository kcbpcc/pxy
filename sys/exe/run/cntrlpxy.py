...
###########################################################################################################################################################################################################    
    ...
    mis_filtered_df = PRINT_df_sorted_display[((PRINT_df_sorted_display['PnL'] > 0) & (PRINT_df_sorted_display['PL%'] < 0)) | ((PRINT_df_sorted_display['PnL'] < 0) & (PRINT_df_sorted_display['PL%'] > 0))]
