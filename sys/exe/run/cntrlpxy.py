...
###########################################################################################################################################################################################################
    ...
    EXE_df = pxy_df[['qty', 'avg', 'close', 'ltp', 'open', 'high', 'low', 'PnL%_H', 'dPnL%', 'product', 'source', 'key', 'pxy', 'yxp', 'PnL%', 'PnL','stp', 'ltp']]

    PRINT_df = pxy_df[['source','product','qty','key','yxp','pxy','PnL%','PnL','stp', 'ltp']]
