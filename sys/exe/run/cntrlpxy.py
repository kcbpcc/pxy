...
###########################################################################################################################################################################################################
    ...
    PRINT_df['💫'] = PRINT_df['Px'].apply(lambda Px: '🟢' if Px == 'Bull' else ('🔴' if Px == 'Bear' else ('🌚' if Px == 'Sell' else ('🌞' if Px == 'Buy' else Px))))
    ...
    PRINT_df_sorted['💫'] = PRINT_df_sorted['Px'].apply(lambda Px: Px[:2] if isinstance(Px, str) else Px)
