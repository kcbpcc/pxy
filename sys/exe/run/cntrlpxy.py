...
###########################################################################################################################################################################################################
    ...
    PRINT_df['O'] = PRINT_df['O'].apply(lambda O: '🟢' if O == 'Bull' else ('🔴' if O == 'Bear' else ('❌' if O == 'Sell' else ('✅' if O == 'Buy' else O))))
...
###########################################################################################################################################################################################################    
    ...
    PRINT_df_sorted['O'] = PRINT_df_sorted['O'].apply(lambda O: O[:2] if isinstance(O, str) else O)
