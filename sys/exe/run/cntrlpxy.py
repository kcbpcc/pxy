...
###########################################################################################################################################################################################################
    ...
    PRINT_df = PRINT_df.rename(columns={'source': 'X', 'product': 'Y', 'qty': 'Qt', 'smbchk': 'O'})
...
###########################################################################################################################################################################################################    
    ...
    PRINT_df_sorted['O'] = PRINT_df_sorted['O'].apply(lambda OO: OO[:2] if isinstance(OO, str) else OO)
