...
###################################################################################"PXY® PreciseXceleratedYield Pvt Ltd™########################################################################################################################
    ...
    combined_df['min'] = 1.5
     combined_df['tPL%'] = (np.where(nsma == 'up', np.maximum(1 * combined_df['tPL%'], combined_df['min']), np.where(nsma == 'down', np.maximum(combined_df['tPL%'] * 0.5, combined_df['min']), combined_df['min'])))
###################################################################################"PXY® PreciseXceleratedYield Pvt Ltd™########################################################################################################################
