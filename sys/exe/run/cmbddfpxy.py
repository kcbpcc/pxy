...
def process_data():
    try:
        ...
        positions_df = positions_df.rename(columns={'average_price': 'p_average_price'})
        ...
        combined_df = pd.merge(holdings_df, positions_df, on=['exchange', 'tradingsymbol'], how='outer')
