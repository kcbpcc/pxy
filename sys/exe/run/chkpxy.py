...
python_files = [f for f in os.listdir(directory) if f.endswith(".py") and f != "pxy.py" and f != "chkpxy.py" and f != "login_get_kite.py"]
...
if failed_files:
    print(f"\033[91m{len(failed_files)} PXY® had problems ❌❌ :\033[0m")
