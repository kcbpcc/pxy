...
def process_csv(csv_file_path_nrml):
    ...
    try:
        ...
        with open(csv_file_path_nrml, newline='') as csvfile:
            # Create a CSV reader
            ...
            for row in csvreader:
                ...
                try:
                    total_profit += float(processed_values[-1]) if float(processed_values[-1]) >= 0 else 0
                except ValueError:
    ...
    print(f"Extras: ₹{total_profit:.2f}".rjust(40))

    # Return the total_profit value
    return total_profit

# Replace "filePnL_nrml.csv" with your actual CSV file path
csv_file_path_nrml = "filePnL_nrml.csv"
# Call the function and get the total_profit_nrml value
total_profit_nrml_main = process_csv(csv_file_path_nrml)

# Now you can use total_profit_nrml_main in your main code
# print("Total Profit in Main:", total_profit_nrml_main)
