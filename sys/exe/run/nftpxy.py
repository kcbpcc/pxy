...
def get_nse_action():
    ...
    try:
        ...
        # Extract today's open, high, low, and current price
        ...
        # Extract yesterday's close and open prices
        ...
        print(f"Error during data download or processing: {e}", file=sys.stderr)
