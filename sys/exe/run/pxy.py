...
while True:
    ...
    if mktpxy == 'Bear':
        ...
        subprocess.run(['python3', 'cntrlpxy.py'])
        console.print(f"{nse_action} Day||⚡{nse_power} ⚡||[bold]Market on standby![/bold]")
    ...
    print("-" * 42)  # Print a line of 42 dashes
    if mktpxy == "Bull":
        console.print("🏛🏛 PXY® PreciseXceleratedYield Pvt Ltd™ 🏛🏛", style=green_style)
    elif mktpxy == "Buy":
        console.print("🏛🏛 PXY® PreciseXceleratedYield Pvt Ltd™ 🏛🏛", style=green_style)
    elif mktpxy == "Sell":
        console.print("🏛🏛 PXY® PreciseXceleratedYield Pvt Ltd™ 🏛🏛", style=red_style)
    elif mktpxy == "Bear":
        console.print("🏛🏛 PXY® PreciseXceleratedYield Pvt Ltd™ 🏛🏛", style=red_style)
    else:
