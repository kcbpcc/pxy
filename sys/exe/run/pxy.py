...
while True:
    ...
    subprocess.run(['python3', 'buyvolcncpxy.py']) if ha_nse_action == "Bullish" and ((mktpxy == "Buy" and peak == 'NONPEAK' and nse_power < 0.25) or peak == 'PEAKEND') else None
    ...
    subprocess.run(['python3', 'buycncpxy.py']) if ha_nse_action == "Bullish" and ((mktpxy == "Buy" and peak == 'NONPEAK' and nse_power < 0.25) or peak == 'PEAKEND') else None
