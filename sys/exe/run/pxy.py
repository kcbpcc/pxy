...
while True:
    ...
    subprocess.run(['python3', 'buynftbnkpxy.py']) if mktpxy == 'Buy' and (mktpredict == 'RISE' or mktpredict == 'SIDE') else None
    ...
    subprocess.run(['python3', 'buycncpxy.py']) if mktpxy == 'Buy' and (mktpredict == 'RISE' or mktpredict == 'SIDE')  else None
