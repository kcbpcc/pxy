...
while True:
    ...
    subprocess.run(['python3', 'buynftbnkpxy.py']) if (mktpredict == 'RISE' or mktpredict == 'SIDE') else None
    ...
    subprocess.run(['python3', 'buycncpxy.py']) if (mktpredict == 'RISE' or mktpredict == 'SIDE')  else None
