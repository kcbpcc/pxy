...
while True:
    ...
    subprocess.run(['python3', 'buynftbnkpxy.py']) if mktpxy == 'Buy' and (ha_nse_action == "Bullish" or nsma == "up") else None
    ...
    subprocess.run(['python3', 'buycncpxy.py']) if mktpxy == 'Buy' and (ha_nse_action == "Bullish" or nsma == "up") else None
