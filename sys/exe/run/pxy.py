...
while True:
    ...
    if mktpxy == 'Bear':
        ...
        subprocess.run(['python3', 'buyoptpxy.py']) if SMAfty == 'down' and peak == 'NONPEAK' else print(f"Not buying as SMAfty={SMAfty} and peak={peak}")
    elif mktpxy == 'Buy':
        print("It's a ⤴️-Buy-⤴️ time, Buying now..........")
        subprocess.run(['python3', 'buypxy.py']) if SMAfty == 'up' and peak == 'NONPEAK' else print(f"Not buying as SMAfty={SMAfty} and peak={peak}")
        subprocess.run(['python3', 'buyoptpxy.py']) if SMAfty == 'up' and peak == 'NONPEAK' else print(f"Not buying as SMAfty={SMAfty} and peak={peak}")
    elif mktpxy == 'None':
        subprocess.run(['python3', 'cntrlpxy.py'])
