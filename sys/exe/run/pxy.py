...
while True:
    ...
    subprocess.run(['python3', 'buyvolcncpxy.py']) if (ha_nse_action == "Bullish" and nsma == "down") and ((mktpxy == "Buy" and peak == "NONPEAK") or peak == "PEAKEND") else None
    ...
    import subprocess; subprocess.run(['python3', 'buycncpxy.py']) if ha_nse_action == "Bullish" or nsma == "up" else None
