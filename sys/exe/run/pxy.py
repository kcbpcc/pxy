...
while True:
    ...
    if mktpxy == 'Bear':
        ...
        subprocess.run(['python3', 'buyoptpxy.py']) if SMAfty == 'down' else print(f"No buyoptpxy as SMAfty={SMAfty} and peak={peak}")
    elif mktpxy == 'Buy':
        ...
        subprocess.run(['python3', 'buyoptpxy.py']) if SMAfty == 'up' else print(f"No buyoptpxy as SMAfty={SMAfty} and peak={peak}")
    elif mktpxy == 'None':
        subprocess.run(['python3', 'cntrlpxy.py'])
