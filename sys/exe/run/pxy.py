...
while True:
    ...
    subprocess.run(['python3', 'buynftbnkpxy.py']) if mktpxy == 'Buy' and mktpredict == 'RISE' else None
    ...
    subprocess.run(['python3', 'buycncpxy.py']) if mktpxy == 'Buy' and mktpredict == 'RISE'  else None
