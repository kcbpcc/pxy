...
while True:
    ...
    subprocess.run(['python3', 'buyvolcncpxy.py']) if (ha_nse_action == "Bullish" or nsma == "up" ) and ((mktpxy == "Buy" and peak == 'NONPEAK' ) or peak == 'PEAKEND') else None
    ...
    subprocess.run(['python3', 'buycncpxy.py']) if (ha_nse_action == "Bullish" or nsma == "up" ) and ((mktpxy == "Buy" and peak == 'NONPEAK' ) or peak == 'PEAKEND') else None
