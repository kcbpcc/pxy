...
summary_sentence = f"{BRIGHT_YELLOW}SUMMARY: CAP:{total_invested_all} P&L:{total_pl_all:5.0f} {RESET}"
...
print(🔎 + summary_statement.rstrip().rjust(len(🔎) + len(summary_statement)))
print("━" * 42)
