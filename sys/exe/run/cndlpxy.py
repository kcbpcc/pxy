...
print(f"🔆{day_change_sign}{GREEN if Day_Change >= 0 else RED}{Day_Change:.2f}{RESET}⌛{open_change_sign}{GREEN if Open_Change >= 0 else RED}{Open_Change:.2f}{RESET}⚡{nse_power:.2f} {nsmawave} 🟥-{pedepth}🚦{macd}🚦🟩+{cedepth}")
