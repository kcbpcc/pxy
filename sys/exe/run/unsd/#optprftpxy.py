...
def process_csv(csv_file_path):
    ...
    headers_for_printing = ['key', 'PL%', 'PnL']
    ...
    column_widths = {'key': 8, 'PL%': 6, 'PnL': 8}
    ...
    try:
        ...
        with open(csv_file_path, newline='') as csvfile:
            ...
            # Iterate over each row in the CSV file and add the last 3 columns to the table
            for row in csvreader:
                ...
                # Extract values of the last 3 columns
                last_columns_values = row[-3:]
                ...
                # Add the last 3 columns from the row to the table
...
csv_file_path = "filePnL_nrml.csv"
