...
def get_holdingsinfo(csv_file_path):
    try:
        ...
        selected_holdings_df = holdings_df[(holdings_df['qty'] != 0) & (holdings_df['qty'] >= 0) & (holdings_df['product'] != 'CNC')].copy()
        ...
        green_Stocks_df = selected_holdings_df[selected_holdings_df['perc'] > 1.4]
