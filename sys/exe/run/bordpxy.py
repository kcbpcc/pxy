...
def printbord(Day_Change, result, total_PnL_percentage, total_dPnL, total_PnL, total_dPnL_percentage,
    ...
    output_lines.append(left_aligned_format.format(f"Capital:{BRIGHT_YELLOW}{all_Stocks_capital_lacks}{RESET}") +
                        right_aligned_format.format(f"Value:{BRIGHT_YELLOW }{all_Stocks_worth_lacks}{RESET}"))             
