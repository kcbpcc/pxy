...
def printbord(Day_Change, result, total_PnL_percentage, total_dPnL, total_PnL, total_dPnL_percentage,
    ...
    output_lines.append(
        left_aligned_format.format(
            f"{BRIGHT_YELLOW}{'Green Stocks'.zfill(3)}{RESET}:{str(red_Stocks_count).zfill(3)}"
        ...
        right_aligned_format.format(
            ...
            f"{BOLD}{UNDERLINE}®{RESET}      {BRIGHT_YELLOW}{'Red Stocks'.zfill(3)}{RESET}:{str(green_Stocks_count).zfill(3)}"
        )
    )
