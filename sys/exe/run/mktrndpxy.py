...
def fetch_data(symbol, period="5d", interval="2m"):
...
def calculate_last_twenty_heikin_ashi_colors(symbol, period="5d", interval="2m"):
...
def get_market_status_for_symbol(symbol, period="5d", interval="2m"):
