...
output_lines.append(left_aligned_format.format(f"ndLoss: {BRIGHT_RED if nifty_loss < 0 else BRIGHT_GREEN}{nifty_loss}{RESET}") +
                   right_aligned_format.format(f"ndProfit: {BRIGHT_GREEN if nifty_profit > 0 else BRIGHT_RED}{nifty_profit}{RESET}"))

output_lines.append(left_aligned_format.format(f"bdLoss: {BRIGHT_RED if bank_loss < 0 else BRIGHT_GREEN}{bank_loss}{RESET}") +
                   right_aligned_format.format(f"bdProfit: {BRIGHT_GREEN if bank_profit > 0 else BRIGHT_RED}{bank_profit}{RESET}"))
