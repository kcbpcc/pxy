...
# Loop to continuously fetch and display sentiment
while True:
    ...
    for exchange, details in exchanges.items():
        ...
        if sentiment:
            ...
            console.print(f"{details['name']}: [{sentiment_style}]{sentiment}[/{sentiment_style}]  ", end="")
    ...
    time.sleep(60)  # Fetch sentiment every 60 seconds
