...
async def main():
    ...
    expiry_year, expiry_month, expiry_day = get_this_thursday()
    option_type = 'PE'  # Change option type to PE for Put Option
    ...
    if buy_order_placed:
        ...
        if isinstance(order_history, list) and order_history:
            ...
            if executed_price > 0:
                # Calculate target price (Adjust as per your strategy)
                target_price = round(executed_price + 10, 1)  # Example: Add 10 to executed price
